...
<div class="container">
		...
		<div class="col-md-12">
			<div class="page-title-wrap">
				<div class="page-title-inner">
					<div class="row">
						<div class="col-md-12">
							<div class="title-widget-cursive">Kullanıcı Kaydı</div>
	...
	<form action="nedmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
			<div class="col-md-6">
				<div class="title-bg">
					<div class="title-widget-cursive">Kayıt Bilgileri</div>
				</div>
			...
			<div class="col-md-6">
				<div class="title-bg">
					<div class="title-widget-cursive">Şifrenizi mi Unuttunuz?</div>
				</div>


				<center><img width="250" src="dimg/indir.jpg"></center>
			</div>
		</div>
	</div>
</form>
